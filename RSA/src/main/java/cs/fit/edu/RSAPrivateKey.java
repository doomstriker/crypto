...
public class RSAPrivateKey extends RSAKey {
	...
	/**
	 * Genereates a private & public key pair
	 * @param privFilename the filename for the private key
	 * @param pubFileName the filename for the public key
	 */
	public void generateKeyPair(String privFilename,String pubFileName) {
		generatePrivateKey(privFilename);
		generatePublic(pubFileName);
	}
	 ...
	 * @param pubFileName
	 */
	public void generatePrivateKey(String privFilename) {
